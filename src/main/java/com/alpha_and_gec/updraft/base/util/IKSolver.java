...
public class IKSolver {
    ...
    public IKSolver(LivingEntity entity, int nodeCount, double nodeDist, double bodyLength, double VertLimPercentage, int returnRate, boolean tailHasGravity, boolean returnToCenter) {
        ...
        this.perTickRate = returnRate;
        //how fast the tailreturns to center
        ...
        this.torsoFrontOffset = this.torsoFrontOffset.multiply(1, 1, bodyLength);
        this.torsoBackOffset = this.torsoBackOffset.multiply(1, 1, bodyLength);
