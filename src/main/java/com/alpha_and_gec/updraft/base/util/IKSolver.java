...
public class IKSolver {
    ...
    public IKSolver(LivingEntity entity, int nodeCount, double nodeDist, double VertLimPercentage, int returnRate, boolean tailHasGravity, boolean returnToCenter) {
