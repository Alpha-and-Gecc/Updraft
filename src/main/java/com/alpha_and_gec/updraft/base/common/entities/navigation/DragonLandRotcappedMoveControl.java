...
public class DragonLandRotcappedMoveControl extends MoveControl {

    public float MaxPerTickYRot;

    public DragonLandRotcappedMoveControl(Mob pMob, float maxPerTickYRot) {
        super(pMob);
        this.MaxPerTickYRot = maxPerTickYRot;
    }
    ...
    public void tick() {
        if (this.operation == MoveControl.Operation.STRAFE) {
            ...
            this.mob.setYRot(this.rotlerp(this.mob.getYRot(), f9, this.MaxPerTickYRot));
